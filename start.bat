...
set "AT_FLAGS=--symbol mt5:XAUUSD,mt5:BTCUSD --interval 15m,30m --risk-pct 0.03 --max-total-risk-pct 0.08 --daily-loss-pct 0.05 --weekly-loss-pct 0.10 --streak-halve 3 --send"
