//+------------------------------------------------------------------+
//|                                                      ZonelabIFVG.mq5 |
//|  EA backtest inversion fair value gap di MT5 Strategy Tester.      |
...
//|                                                                    |
//|  2. ARAHNYA SUDAH DIUKUR DAN NEGATIF. docs/CALIBRATION.md H8:       |
//|     fvg -0,165 (t=-2,23), order_block -0,274 (t=-4,22) lawan kontrol |
//|     yang hanya tahu gerakan 20 bar terakhir. Mengetahui sebuah box   |
//|     sudah terbalik membuat tebakan arah LEBIH BURUK. EA ini ada      |
//|     untuk membuktikan port-nya presisi, bukan untuk mencari profit.  |
