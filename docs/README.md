...
Direktori ini berisi 6 dokumen prosa dan 21 berkas bukti mentah. Tanpa peta,
pembaca yang membukanya melihat 27 berkas dan tidak bisa tahu prosa mana membaca
data mana. Itu satu-satunya alasan berkas ini ada.
...
| [WALKFORWARD-MT5.md](WALKFORWARD-MT5.md) | Apakah gerbangnya bertahan di luar sampel, per fold, termasuk fold yang gagal |
| [QA-PRODUKSI.md](QA-PRODUKSI.md) | Catatan QA/QC menuju produksi, 14 bagian, setiap angka dari perintah yang dijalankan |

## Berkas bukti, dan tool yang menghasilkannya
...
konvensi ini. Diperiksa 21 Agustus 2026: ke-21 berkas punya tool yang cocok, tidak
ada yang orphan.
...
> [!IMPORTANT]
> Kolom "dibaca prosa" kosong **bukan** berarti berkasnya mati. Ia keluaran mentah
...
> berkas. Menghapus salah satunya akan memutus provenance sebuah klaim yang sudah
...
keluarannya diarahkan ke berkas bersuffiks `-mt5` supaya kedua venue tidak saling
