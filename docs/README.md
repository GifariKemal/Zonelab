...
| `gap_outcomes.json` | `tools.gap_outcomes` | - | lima objek gap yang digambar dan belum pernah diukur: breakaway, measuring, opening, ifvg, breaker. breakaway n=0 (cabangnya tak tercapai), measuring dicapai 2,70 bar lebih cepat dari mirror-nya (t=-3,65), sisanya null. Dua kontrol yang gugur ikut dilaporkan |
