...
LAYERS: tuple[Layer, ...] = (
    ...
    Layer(
        ...
        evidence=(
            ...
            "AUTODRAWING IS 7 OF 7, the cleanest of any layer: 6 of 6 zones located, "
            "0 stacked and 0 thin, both edges within 0.4px of where the price scale "
            "puts them, and a legible left edge on all 6. The crowding that makes "
            "pixel-truth red for ifvg does not appear, because pools sit at "
            "different prices by definition. "
