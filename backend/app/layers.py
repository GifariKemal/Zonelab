...
LAYERS: tuple[Layer, ...] = (
    ...
    Layer(
        ...
        evidence=(
            ...
            "identical after the push (n=598, PF 1.113). XAUUSD daily, tolerance "
            "against min_touches: at touches=2 every tolerance sits between 0.781 "
            "and 0.893, so the tolerance alone moves nothing. Demanding a THIRD "
            "touch is what opens the door - 1.170 at tol 0.5 on n=108 and 1.193 at "
            "tol 1.0 on n=163 - which is what this note guessed before it was "
            "measured. Then the controls close it again: the tol-1.0 arm LOSES to "
            "its own placebo (1.193 against 1.223), and the two that beat their "
            "placebo fail out of sample - tol 0.5 t3 reads 1.783 in sample and "
            "0.657 out, the hardest fall any detector has taken in this rig, and "
            "tol 0.5 t4 reads 0.885 out. At COMEX GC1! the picture is the same: "
            "0.810 at t2, and 1.016 at t3 against a placebo of 1.031. "
